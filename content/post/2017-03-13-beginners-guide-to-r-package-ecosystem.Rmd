...
twitterImg: /img/package_banner.png
description: "Beginners Guide to R Package System."
date: '2017-03-13'
...
In the previous post,  we learnt about getting help in R. In this post, we will learn about R packages. Packages are fundamental to R. There are approximately 15000 packages available on [CRAN](https://cran.r-project.org/) or the Comprehensive R Archive Network.
