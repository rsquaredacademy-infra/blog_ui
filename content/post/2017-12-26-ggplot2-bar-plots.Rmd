...
This is the ninth post in the series **Elegant Data Visualization with 
ggplot2**. In the previous post, we learnt to build line charts. In this post, 
we will learn to:
...
and code can be downloaded from [here](https://gist.github.com/rsquaredacademy/096329693fa1f9313771d4e259cce1ec).
...
background color of the bars. We will look at that later in the post.
