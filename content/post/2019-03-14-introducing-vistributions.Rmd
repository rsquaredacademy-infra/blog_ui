...
description: "Visually explore probability distributions with vistributions."
date: '2019-03-14'
slug: introducting-vistributions
topics:
  - distributions
tags:
  - vistributions
...
knitr::include_graphics("/img/vistributions_banner.png")
```
...
I am happy to introduce the **vistributions** package, a set of tools for 
...
or try the live version [here](https://www.rsquaredcomputing.com/vistributions/).

```{r tube1, eval=TRUE, echo=FALSE}
blogdown::shortcode("youtube", "Wa44jxAJvTE")
```

Read on to learn more about the features of **vistributions**, or see the 
[vistributions website](https://vistributions.rsquaredacademy.com/) for 
...
```{r tab_gif, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("/img/tab_gif.png")
```
...
The [vistributions website](https://vistributions.rsquaredacademy.com/) includes 
...
- [Introduction to vistributions](https://vistributions.rsquaredacademy.com/articles/introduction-to-vistributions.html) 
...
requests) can be posted to [github tracker](https://github.com/rsquaredacademy/vistributions/issues).
