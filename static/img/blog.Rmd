...
knitr::include_graphics("course_card_cline.png")
```
...
knitr::include_graphics("windows-terminal-1.png")
```
...
knitr::include_graphics("windows-terminal-2.png")
```
...
knitr::include_graphics("windows-terminal-3.png")
```
...
knitr::include_graphics("linux-terminal.png")
```
...
knitr::include_graphics("wsl-1.png")
```
...
knitr::include_graphics("wsl-2.png")
```
...
knitr::include_graphics("rstudio-termina.png")
```
...
knitr::include_graphics("prompt-canva.png")
```
...
unzip zip_example.zip –d examples
```
...
argument. In the below example, we execute the command `ls -a`. Note how `-a` is
...
to be redirected to the `release.txt` file. The `stdout` argument can be used to
redirect output to a file or the R console. In the below example, we redirect 
...
```{r rstudio_shell, echo=FALSE, fig.align="center", out.width="70%"}
knitr::include_graphics("rstudio_shell.gif")
```
...
```{r shell_rmarkdown, echo=FALSE, fig.align="center", out.width="70%"}
knitr::include_graphics("shell_markdown.png")
```
...
```{r r99, echo=FALSE}
system2("rm", c("-r", "J:/R/bash-try/cline"))
system2("rm", c("-r", "J:/R/bash-try/examples"))
```

```{bash c99, echo=FALSE}
cd ..
cp -r rstudio-export bash-try/cline
``` 
